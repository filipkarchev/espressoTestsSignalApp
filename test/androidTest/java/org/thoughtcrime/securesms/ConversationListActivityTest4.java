                ...
                allOf(withId(R.id.number),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        1),
                                2)));
        appCompatEditText2.perform(scrollTo(), replaceText("258"), closeSoftKeyboard());

        ViewInteraction editText = onView(
                allOf(withId(R.id.number), withText("258"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.registration_container),
                                        1),
                                2),
                        isDisplayed()));
        editText.check(matches(withText("258")));
    }
